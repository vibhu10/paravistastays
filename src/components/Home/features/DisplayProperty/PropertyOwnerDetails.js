...
const PropertyOwnerDetails = () => {
  return (
    <div className="property-owner-details">
      ...
      <div className="property-owner-details__content">
        <div className="property-owner-details__avatar-section">
          <img
          ...
          <div className="property-owner-details__info">
            ...
            <div className="property-owner-details__rating">
              ...
              <span className="property-owner-details__stars">
                ⭐⭐⭐⭐⭐
              </span>
            </div>
        ...
        <div className="property-owner-details__details">
